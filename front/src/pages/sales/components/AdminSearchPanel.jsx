...
const WH = { ramses: 'رمسيس', october: 'أكتوبر' };
              ...
              {searchResults.map(inv => (
                ...
                >
                  <div className="flex items-center justify-between flex-wrap gap-2">
                    ...
                    <div className="flex items-center gap-2">
                      <span className="text-sm font-bold text-gray-700">
                        {fmtFixed(inv.totalAmount)} ج.م
                      </span>
                      <span className={`text-xs px-1.5 py-0.5 rounded-full font-medium ${STATUS[inv.status]?.cls || 'bg-gray-100 text-gray-500'}`}>
                        {STATUS[inv.status]?.text || inv.status}
                      </span>
                  ...
                  <div className="flex gap-3 mt-0.5 text-xs text-gray-400">
                    ...
                    <span>{WH[inv.warehouse] || inv.warehouse}</span>
