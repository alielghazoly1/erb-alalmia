// ─── components/StatementTablePagination.jsx ─────────────────────────────────
// Pagination للجداول داخل كشف العميل — مخفي في الطباعة
// ────────────────────────────────────────────────────────────────────────────

export default function StatementTablePagination({ page, totalPages, total, onPageChange }) {
  ...
  return (
    <div className="flex items-center justify-between mt-3 pt-3 border-t text-sm print:hidden">
      <span className="text-gray-500">
        صفحة {page} / {totalPages} ({total.toLocaleString()} سجل)
      </span>
