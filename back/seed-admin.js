// ─── reset_stock.js ───────────────────────────────────────────────────────────
// سكريبت لتصفير أرصدة جميع الأصناف في جميع المخازن والمواسم
//
// ماذا يفعل:
//   1. يُصفّر quantity و weight في جدول item_stocks (كل المخازن والمواسم)
//   2. يحذف جميع سجلات stock_movements
//
// طريقة التشغيل:
//   node reset_stock.js
//
// ⚠️  تحذير: العملية لا يمكن التراجع عنها — تأكد من عمل backup أولاً
// ─────────────────────────────────────────────────────────────────────────────
